/* MIT License - Copyright (c) 2021 Matthew Boakes */
/* Inspired and Modification of Jack Babb - Infinite Image Loop - https://codepen.io/zendergo2/pen/VjQpOo */

/* Inspiration by Chris Coyier - https://css-tricks.com/infinite-all-css-scrolling-slideshow/ */

class InfiniteSlider {

    constructor(animTime, container) {
...
function createInfiniteSlider(container, animTime = '10000') {
    return new InfiniteSlider(animTime, container)
}
...
function setupInfiniteSlider(slider) {
    ...
    slider.animate()
    slider.container.addEventListener('mouseenter', slider.halt.bind(slider))
    slider.container.addEventListener('mouseleave', slider.go.bind(slider))
...
document.addEventListener('DOMContentLoaded', function () {
    Array.prototype.slice.call(document.querySelectorAll('.slider-container'))
        .map(container => createInfiniteSlider(container))
        .forEach(slider => setupInfiniteSlider(slider));
});
